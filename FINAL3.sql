...
--
-- Host: 127.0.0.1:3306
-- Waktu pembuatan: 16 Mar 2021 pada 13.46
...
(33, 1, 'Surfaces_-_Sunday_Best_(Official_Music_Video).mp3', 'audio', 'pop', 'asdfasdf', '2021-03-12', ''),
(34, 1, 'https://www.youtube.com/watch?v=NUVn0QXVOeM', 'youtube', 'pesawat', 'coba', '2021-03-12', 'pasted_image_0.png'),
(35, 1, 'https://www.youtube.com/watch?v=zOgERE8HHtg', 'youtube', 'coba lagi', 'asdfasdf', '2021-03-15', 'pasted_image_0.png');
...
(33, 39, 'gas lah', '2021-03-04', '22:39:00', 'wkwwwkkwkw', '80jykz32log21.png'),
(34, 39, 'coba 2', '2021-03-07', '13:55:00', 'gaskan lah', '80jykz32log212.png'),
(35, 39, 'markicob', '2021-03-12', '12:53:00', 'dfasdf', '61674518a66f1abd5e6c1c227a29fc7b.jpg'),
(36, 39, 'gas lah 2', '2021-03-13', '12:54:00', 'asdfasdf', '61674518a66f1abd5e6c1c227a29fc7b1.jpg'),
(37, 40, 'BARITA TERKINI', '2021-03-16', '16:20:00', 'fasdf', '80jykz32log212.png'),
(38, 40, 'BARITA TERKINI 2', '2021-03-16', '16:21:00', 'fasdf', '80jykz32log213.png'),
(39, 39, 'BARITA TERKINI 3', '2021-03-16', '16:23:00', 'asdfasfd', '80jykz32log214.png'),
(40, 39, 'BARITA TERKINI 4', '2021-03-16', '16:23:00', 'asdfasdf', '80jykz32log215.png');
...
(39, 'rizal', '082334900069', 'asdfasdf', '61674518a66f1abd5e6c1c227a29fc7b3.jpg', '', '', ''),
(40, 'rizal 2', '0823345623123', 'dfasdfasdf', '61674518a66f1abd5e6c1c227a29fc7b.jpg', '', '', '');
...
INSERT INTO `rating` (`ID_RATING`, `ID_JADWAL`, `ID_PENYIAR`, `ID_USER`, `ID_KOMENTAR`, `ID_GALERI`, `KATEGORI_RATING`, `RATING`, `KOMENTAR`) VALUES
(5, NULL, NULL, NULL, NULL, NULL, 'website', 1, 'coba'),
(6, NULL, NULL, NULL, NULL, NULL, 'website', 0, 'coba'),
(7, NULL, NULL, NULL, NULL, NULL, 'website', 1, 'coba'),
(8, NULL, NULL, NULL, NULL, NULL, 'website', 1, 'coba'),
(9, 33, NULL, 22, NULL, NULL, NULL, 1, 'coba'),
(10, 33, NULL, 22, NULL, NULL, NULL, 1, 'coba'),
(11, 33, NULL, 22, NULL, NULL, NULL, 1, 'coba'),
(12, 33, NULL, 22, NULL, NULL, NULL, 0, 'coba'),
(13, 34, NULL, 20, NULL, NULL, NULL, 1, 'boleh hljashdlfkasljdfa asldfjkjhasdf asdlfjkhasdkfj adsofaskldjfh asdlfkjhasdlkjfh asdflkjhaslkdjfh asdfjkasdljfa ljasdfkjlashdf asldjfasdfj asdlfjal;sdkfj asdlfjas;ldkfj asdlfkjasldfkj asdlfkasd;lfkj asd;lfkjasdlfkj asd;flkjasldfkj aldsfkasldfj asdlfjas;dlfkjals '),
(14, 34, NULL, 20, NULL, NULL, NULL, 0, 'jlajdklfasdf askldjf;lkajdfl;as asdklfjasdlfkjasdf klasjdfl;kjasdf lkajsdlf;kja ;lkjasd;flkjas ;lkajsdf;lkjsadklf '),
(15, 35, NULL, 22, NULL, NULL, NULL, 1, 'dfasdfasdf'),
(16, 36, NULL, 22, NULL, NULL, NULL, 1, 'dfasdf'),
(17, NULL, NULL, 27, NULL, NULL, 'website', 1, 'coba'),
(18, 36, NULL, 27, NULL, NULL, NULL, 1, ''),
(19, 36, NULL, 27, NULL, NULL, NULL, 1, ''),
(20, NULL, NULL, 28, NULL, NULL, 'website', 1, 'sdasdfasdf'),
(21, 35, NULL, 28, NULL, NULL, NULL, 1, '');
...
(23, 3, 'coba@gmail.com', 'coba', '12345678', '12345678901', 1, '61674518a66f1abd5e6c1c227a29fc7b2.jpg'),
(25, 1, 'skfm2@gmail.com', 'RADIO SUARA KOTA', '$2y$10$14P0oWWv9a/.HqfFPE.EYuZKUwCkjtcTHyu1O5lIzcx', '12345678900', 1, '80jykz32log213.png'),
(27, 3, 'user@gmail.com', 'user', '$2y$10$U0Ih2yJlpcl2abvVSsi1Cu/YpSjjPyFJ8lU9B1EbeOMGSMP2NGIn2', '082334900069', 1, '80jykz32log211.png'),
(28, 3, 'user2@gmail.com', 'user 2', '$2y$10$/E5XIxX1JyD4GXcHXkF9KuKTdPV857oCihOSWkPdhiwa4KywkOCHG', '123456789', 1, '61674518a66f1abd5e6c1c227a29fc7b1.jpg');
...
--
ALTER TABLE `link_stream`
  MODIFY `ID_STREAM` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT untuk tabel `penyiar`
--
ALTER TABLE `penyiar`
  MODIFY `ID_PENYIAR` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
...
--
ALTER TABLE `user_ip`
  MODIFY `ID_IP` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=250;
