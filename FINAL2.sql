...
--
-- Host: 127.0.0.1:3306
-- Waktu pembuatan: 14 Mar 2021 pada 13.38
...
(22, 1, 'skfm@gmail.com', 'RADIO SUARA KOTA', '$2y$10$d2dO8FKHuGJme0VBtJvjs.xRcAoP.F0NqKfETZpQ4XwB/NRQWcIvm', '082334900069', 1, '80jykz32log211.png'),
(23, 3, 'coba@gmail.com', 'coba', '12345678', '12345678901', 1, '61674518a66f1abd5e6c1c227a29fc7b2.jpg'),
(24, 3, 'h06218021@uinsby.ac.id', 'yusrizal syarief', '$2y$10$YBXLUYcfD1OoRQiUkm2TS.aHQwC33xTQ5kVxgwljXto', ' ', 1, 'default.jpg'),
...
--
ALTER TABLE `penyiar`
  MODIFY `ID_PENYIAR` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
...
--
ALTER TABLE `user_ip`
  MODIFY `ID_IP` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=153;
