...
<footer class="footer spad set-bg" data-setbg="<?= base_url()?>assets/user/img/footer-bg.png">
        <div class="container">
			...
			<div class="footer__copyright__text">
				<p>Copyright &copy; <script>document.write(new Date().getFullYear());</script> All rights reserved Radio Suara Kota Probolinggo | This template is made with 
...
<script>
        ...
        if(flashBuku){
            ...
            flashBuku == 'Form Harus Lengkap!' || flashBuku == 'Form Harus Lengkap!'){
                Swal.fire({
                    title: '',
                    text: flashBuku,
                    icon: 'warning'
